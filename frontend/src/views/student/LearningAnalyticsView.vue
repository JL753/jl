        ...
        <div class="chart-card large">
          <div class="card-header">
            ...
            <el-radio-group v-model="behaviorType" size="small">
              <el-radio-button label="study">学习时长</el-radio-button>
              <el-radio-button label="quiz">刷题数量</el-radio-button>
              <el-radio-button label="qa">提问次数</el-radio-button>
            </el-radio-group>
          </div>
...
const initCharts = () => {
  ...
  if (habitChart.value) {
    habitInstance = echarts.init(habitChart.value)
    updateHabitChart()
  }
}
