...
const topCards = computed(() => [
  { icon: '📅', label: '参与的会议', value: data.value.summary.todayCourses ?? 2, trend: 12 },
  { icon: '🎓', label: '今日上课数', value: data.value.summary.todayClasses ?? 3, trend: 5 },
  { icon: '👥', label: '辅导学生', value: data.value.summary.students ?? 60, trend: 8 },
  { icon: '📝', label: '作业提交人数', value: data.value.summary.homeworkRate ?? 45, trend: -3 },
  { icon: '📈', label: '学生参与度', value: data.value.summary.participation ?? 60, trend: 15 },
  { icon: '⏰', label: '累积时长', value: data.value.summary.totalHours ?? 226, trend: 22, highlight: true }
])
