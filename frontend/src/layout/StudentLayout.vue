...
.nav-link {
  ...
  &.router-link-active {
    background: linear-gradient(135deg, rgba(103, 194, 58, 0.08), rgba(40, 199, 111, 0.08));
    color: $success-color;
...
.sidebar-foot {
  ...
  padding: $spacing-md;
  border-radius: $radius-medium;
  background: linear-gradient(135deg, rgba(103, 194, 58, 0.05), rgba(40, 199, 111, 0.05));
...
.brand-copy strong { display: block; font-size: 28px; color: #1f9f82; }
...
.student-card { background: linear-gradient(180deg, #f2fffb, #fffdf6); }
