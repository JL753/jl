...
**Q: Redis 连接失败？**
A: 检查 Redis 服务是否启动，默认连接 `127.0.0.1:6379`，无需密码。
...
│  │  │     └─ \_src\_
│  │  │        └─ schema
│  │  │           ├─ information\_schema.FNRwLQ.meta
│  │  │           ├─ mysql.osA4Bg.meta
│  │  │           ├─ performance\_schema.kIw0nw.meta
│  │  │           ├─ sakila.oXLGyQ.meta
│  │  │           ├─ sakila.oXLGyQ.zip
│  │  │           └─ sys.zb4BAA.meta
...
│  │  │  ├─ StudentLayout-D\_b20UKZ.js
│  │  │  ├─ StudentReport-CRg\_jO2k.js
